...
- Each version directory holds two files: `design.md` (the platform's shape at architecture altitude) and `implementation.md` (the numbered, build-ordered steps that realize that design). The `houston-docs` skill defines the structure of each.
