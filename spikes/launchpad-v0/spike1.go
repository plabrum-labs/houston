...
const (
	spike1ProjectName = "launchpad-v0-spike1"
	spike1StackName   = "spike1-cross-provider-recon"
	spike1Tag         = "launchpad-v0-cross-provider-reconciliation"
	passphrase        = "houston-spike-launchpad-v0"
)

func runSpike1(destroy bool) {
	...
	stack, err := auto.UpsertStackInlineSource(ctx, spike1StackName, spike1ProjectName, program,
	...
	fmt.Println("tear down with: go run . -spike=1 -destroy")
}
...
func buildProgram(zone, appID, apiDomain, emailDomain string) pulumi.RunFunc {
	return func(ctx *pulumi.Context) error {
		...
		tags := pulumi.StringMap{
			"houston:spike":  pulumi.String(spike1Tag),
